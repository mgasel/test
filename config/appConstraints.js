module.exports={
   ...
   PASSWORD_AND_CONFIRM_PASSWORD:{EN:'You entered wrong current password',AR:'لابد من تطابق كلمة المرور وتأكيد كلمة المرور'},
   ...
   COUPON_DELETED:{EN:'Counpon deleted sucessfully',AR:'تم حذف القسيمة بنجاح'},
   ...
   START_DATE_LESS_THEN_EXPIRE:{EN:'start date always greater then e date',AR:'تاريخ البدء أقل من تاريخ انتهاء الصلاحية'},
